                    ...
                    when {
                        ...
                        TextUtils.isEmpty(cookingDirection) -> {
                            ...
                            if (dishID == 0) {
                                ...
                                Toast.makeText(this@AddUpdateDishActivity, "add success", Toast.LENGTH_SHORT)
                                    .show()

                                Log.i("add", "add favdish success")
                            } else {
                                mFavDishViewModel.update(favDishDetails)
                                Toast.makeText(this@AddUpdateDishActivity, "update success", Toast.LENGTH_SHORT)
                                    .show()
                            }
...
//                Manifest.permission.WRITE_EXTERNAL_STORAGE
                ...
                override fun onPermissionDenied(response: PermissionDeniedResponse?) {
                    Toast.makeText(this@AddUpdateDishActivity, "you denied read permission", Toast.LENGTH_SHORT).show()
                }
                    ...
                    Glide.with(this)
                        ...
                        .listener(object: RequestListener<Drawable> {
                            override fun onLoadFailed(
                                ...
                                Log.e("failed", "error loading image")
                                return false
                            }
...
//                    mImagePath = saveImageToInternalStorage(selectedPhotoUri)
    ...
    private fun showRationaleDialogForPermission() {
        AlertDialog.Builder(this).setMessage("It looks like you have turned off the permissions required for this feature. Please enable it under application settings")
